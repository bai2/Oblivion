...
exports.tour = function(t) {
  if (typeof t != "undefined") var tour = t; else var tour = new Object();
	var tourStuff = {
		...
		lideres: function() {
			return ['fccamulos','fcvulcano3000','abtryuga','cusho','fcstriker','sonianvrmind','mirandal','davidness','sidaaaaa','quieropastelaa','smorales','adrielandro','fcjuanxzs','furuyajcaos','pokedramafan'];
		},
		cargos: function() {
